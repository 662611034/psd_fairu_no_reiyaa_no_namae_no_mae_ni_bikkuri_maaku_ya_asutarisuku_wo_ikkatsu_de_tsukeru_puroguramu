...
![tool00](https://user-images.githubusercontent.com/48207892/95418343-42688580-0972-11eb-9157-839a4fed89fd.png)
...
-  「直下以外も書き出す(グループ除く)」にチェックを入れると、グループ直下の物ではなく、グループに含まれるすべての「グループでないレイヤー」が書き出し対象になります
